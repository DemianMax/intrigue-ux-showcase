  ...
  return (
    <div ref={containerRef} className="relative min-h-[200vh]">
      ...
      <div className="sticky top-0 w-full h-screen flex items-center overflow-hidden px-6 md:px-12 lg:px-16 bg-[hsl(var(--hero-bg))]">
        ...
        <div className="flex-1 pr-8 md:pr-16">
          ...
          >
            <motion.h1 
              className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-playfair font-bold text-brand-dark dark:text-white leading-tight mb-8"
            ...
            <motion.p 
              className="text-lg md:text-xl text-brand-dark/80 dark:text-gray-300 font-inter font-light leading-relaxed max-w-2xl"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            <motion.h3 className="font-playfair text-3xl md:text-4xl lg:text-5xl text-foreground font-bold mb-8">
              {t("aboutGreeting")}
            </motion.h3>
            ...
            <motion.a
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-brand-accent to-orange-400 text-white font-semibold rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 mt-8"
              whileHover={{ y: -2 }}
            >
              {t("aboutButton")}
        ...
        <div className="flex-1 flex justify-center items-center">
          <motion.div 
            className="relative w-80 md:w-96 lg:w-[450px] xl:w-[500px]"
          ...
          >
            <img
              ...
              className="w-full h-96 md:h-[450px] lg:h-[500px] xl:h-[550px] rounded-2xl shadow-2xl object-cover border-2 border-border"
            />
