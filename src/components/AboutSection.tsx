...
const AboutSection = React.forwardRef<HTMLDivElement>((props, ref) => <section ref={ref} className="w-full max-w-4xl mx-auto px-5 py-20 flex flex-col items-center gap-5" id="sobre">
    ...
    delay: 0.2,
    duration: 0.5
  }} src="/lovable-uploads/b5362a7a-ef6f-46c7-ac27-99fa2fcde1f1.jpg" className="w-70 h-80 rounded-full border-2 border-brand-accent shadow-lg mb-3 object-cover" />
