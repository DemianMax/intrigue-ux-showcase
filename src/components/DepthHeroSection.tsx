...
const DepthHeroSection: React.FC<DepthHeroSectionProps> = ({ onScrollNext }) => {
  ...
  return (
   <div className="relative w-full h-full flex flex-col justify-center items-center bg-gradient-to-b from-[#111827] via-[#111827] to-[#111827]
 overflow-hidden px-6">
      ...
      <motion.button
        ...
        className="absolute bottom-12 left-1/2 -translate-x-1/2 bg-brand-accent/20 hover:bg-brand-accent/40 rounded-full p-4 backdrop-blur-sm transition-all duration-300 shadow-lg"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
