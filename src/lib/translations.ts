export const translations = {
  pt: {
    ...
    aboutParagraph1: 'UX Designer com 20 anos de experiência criando experiências digitais intuitivas, centradas no usuário e com resultados reais.',
    ...
    english: 'Inglês',
    heroTitlePart: ': encontrar respostas ou fazer as perguntas certas?',
    heroSubtitle: 'Eu projeto o invisível para experiências que conectam.',
    heroSubtitleLine2: "Criando soluções digitais centradas no usuário.",
  ...
  en: {
    ...
    english: 'English',
    heroTitlePart: ': find answers or ask the right questions?',
